...
import { Clock, MapPin, MessageCircle, Camera, Truck } from "lucide-react";
        ...
        <div className="container-ketty grid grid-cols-1 gap-10 lg:grid-cols-[400px_1fr]">
          <div className="flex flex-col gap-4">
            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className={linkCardClasses}>
              ...
              <a href={siteConfig.instagram} target="_blank" rel="noopener noreferrer" className={linkCardClasses}>
              <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-pink-600/10 text-pink-700">
                <Camera className="h-6 w-6" aria-hidden="true" />
              </span>
              <span>
                <span className="block font-semibold text-cocoa-800">Instagram</span>
                <span className="block text-sm text-cocoa-600">@ketty.cocina</span>
              </span>
            </a>

            <div className={linkCardClasses} aria-hidden="true">
              <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-brand-600/10 text-brand-700">
                <Truck className="h-6 w-6" aria-hidden="true" />
              </span>
              <span>
                <span className="block font-semibold text-cocoa-800">Envíos y retiro</span>
