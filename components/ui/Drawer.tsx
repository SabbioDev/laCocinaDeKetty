    ...
    <AnimatePresence>
      {open ? (
        <div className="fixed inset-0 z-50" role="dialog" aria-modal="true" aria-label={title}>
          ...
          >
            <div className="flex items-center justify-between border-b border-cocoa-400/20 px-5 py-4">
              ...
              <button
                ...
                onClick={onClose}
                aria-label="Cerrar"
                className="rounded-full p-2 text-cocoa-600 transition-colors hover:bg-manteca-200 hover:text-brand-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600"
              >
